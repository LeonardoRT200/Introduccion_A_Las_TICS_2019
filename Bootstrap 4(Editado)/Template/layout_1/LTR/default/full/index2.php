			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Formularios -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Gestion de informacion</div> <i class="icon-menu" title="Gestion de informacion"></i></li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"></i> <span>Alumnos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="Altas_A.html" class="nav-link">Altas</a></li>
								<li class="nav-item"><a href="Consultar_A.html" class="nav-link">Consultar</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><span>Profesores</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="JSON forms">
								<li class="nav-item"><a href="Altas_P.html" class="nav-link">Altas</a></li>
								<li class="nav-item"><a href="Consultar_P.html" class="nav-link">Consultar</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"></i> <span>Materias</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Text editors">
								<li class="nav-item"><a href="Altas_M.html" class="nav-link">Altas</a></li>
								<li class="nav-item"><a href="Consultar_M.html" class="nav-link">Consultar</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"></i> <span>Grupos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Pickers">
								<li class="nav-item"><a href="Altas_G.html" class="nav-link">Altas</a></li>
								<li class="nav-item"><a href="Consultar_G.html" class="nav-link">Consultas</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"></i> <span>Pagos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Pickers">
								<li class="nav-item"><a href="Altas_T.html" class="nav-link">Transpais</a></li>
							</ul>
						</li>
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"></i> <span>Tutorias</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Pickers">
								<li class="nav-item"><a href="Tutoria.html" class="nav-link">Listar</a></li>
							</ul>
						</li>
